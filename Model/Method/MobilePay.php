 ...
 */
class MobilePay extends \PayEx\Payments\Model\Method\AbstractMethod
{
    ...
    {
        return $this->urlBuilder->getUrl('payex/mobilepay/redirect', ['_secure' => $this->request->isSecure()]);
    }
}
