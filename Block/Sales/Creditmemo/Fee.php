...
namespace PayEx\Payments\Block\Sales\Creditmemo;
            ...
            if ($this->displaySalesFeeBoth()) {
                $parent->addTotal(
                    new DataObject([
                        ...
                        'base_value' => $source->getBasePayexPaymentFee() + $source->getBasePayexPaymentFeeTax(),
                ...
                $parent->addTotal(
                    new DataObject([
                        ...
                        'base_value' => $source->getBasePayexPaymentFee(),
