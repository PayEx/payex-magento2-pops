...
class PartPayment extends \PayEx\Payments\Block\Info\AbstractInfo
{
    /**
     * @var string
     */
    protected $_template = 'PayEx_Payments::info/partpayment.phtml';
    ...
    {
        $this->setTemplate('PayEx_Payments::info/pdf/partpayment.phtml');
        return $this->toHtml();
    }
}
