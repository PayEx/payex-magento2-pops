...
class MasterPass extends \PayEx\Payments\Block\Info\AbstractInfo
{
    /**
     * @var string
     */
    protected $_template = 'PayEx_Payments::info/masterpass.phtml';
    ...
    {
        $this->setTemplate('PayEx_Payments::info/pdf/masterpass.phtml');
        return $this->toHtml();
    }
}
