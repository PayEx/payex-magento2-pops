...
class Evc extends \PayEx\Payments\Block\Info\AbstractInfo
{
    /**
     * @var string
     */
    protected $_template = 'PayEx_Payments::info/evc.phtml';
    ...
    {
        $this->setTemplate('PayEx_Payments::info/pdf/evc.phtml');
        return $this->toHtml();
    }
}
