...
class MobilePay extends \PayEx\Payments\Block\Info\AbstractInfo
{
    /**
     * @var string
     */
    protected $_template = 'PayEx_Payments::info/mobilepay.phtml';
    ...
    {
        $this->setTemplate('PayEx_Payments::info/pdf/mobilepay.phtml');
        return $this->toHtml();
    }
}
