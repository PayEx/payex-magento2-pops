...
require.config({
    paths: { payex: window.checkoutConfig.payment.payex_checkout.frontend_script }
});
...
define(
    ...
    function (
        ...
        return Component.extend({
            defaults: {
                self: this,
                template: 'PayEx_Payments/payment/checkout'
            },
            ...
            placeOrder: function () {
                if (additionalValidators.validate()) {
                    ...
                    // Init PayEx Checkout
                    var payment_id = window.checkoutConfig.payment.payex_checkout.payment_id;
                    if (!payment_id) {
